...
export type PromoCodeNullableResponse = z.infer<
  typeof promoCodeNullableResponseSchema
>;

export const adminDeletePromoCodeResponseSchema = apiOkSchema;
export type AdminDeletePromoCodeResponse = z.infer<
  typeof adminDeletePromoCodeResponseSchema
>;
