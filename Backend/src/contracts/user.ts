 ...
 * Coerces empty strings to undefined so optional fields are truly optional.
 */
...
export type AdminUserNullableResponse = z.infer<
  typeof adminUserNullableResponseSchema
>;

export const adminDeleteUserResponseSchema = apiOkSchema;
export type AdminDeleteUserResponse = z.infer<
  typeof adminDeleteUserResponseSchema
>;
