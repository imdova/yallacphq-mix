...
export type CourseNullableResponse = z.infer<
  typeof courseNullableResponseSchema
>;
...
export type AdminCourseNullableResponse = z.infer<
  typeof adminCourseNullableResponseSchema
>;

export const adminDeleteCourseResponseSchema = apiOkSchema;
export type AdminDeleteCourseResponse = z.infer<
  typeof adminDeleteCourseResponseSchema
>;
